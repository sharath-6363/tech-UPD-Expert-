...
import "../AllCss/ViewTechI.css";
import { BsArrowUp } from "react-icons/bs";
import Commentss from "../AdminComponent/Commentss.js"
const TechnologyUpdates = () => {
  ...
  const searchUpdates = () => {
    const filteredUpdates = updates.filter((update) => {
      ...
      return categoryMatch || descriptionMatch || tagsMatch;
    });
          ...
          {searchResults.length > 0
            ? searchResults.map((update) => (
              <li key={update.id} className="list-group-item">
                <h2 className="m-3"><b>{update.category}</b></h2>
                <div>
                  <div
                  ...
                  {update.description.length > 200 && (
                    ...
                    >
                      {showDescription[update.id] ? (
                        <BsArrowUp className="bg-primary text-light" />
                      ) : (
                        "View More..."
                      )}
                    </button>
                ...
                <div className="updetfrm">
                  ...
                  <img src={update.images} alt="profile" className="getedimg m" />
